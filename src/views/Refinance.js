						...
						<div className='row process-2'>
							<div className='col-sm-4'>
								<div className='process__item'>
									...
									<p>
										Lorem, ipsum dolor sit amet consectetur
										adipisicing elit. Ad repellendus quasi
										corrupti quaerat non ipsam totam
										adipisci magni sed voluptas? Corporis
										sapiente similique totam cum nihil
										accusantium distinctio ullam optio?
									</p>
								</div>
							</div>
							<div className='col-sm-4'>
								<div className='process__item'>
									...
									<p>
										Lorem ipsum, dolor sit amet consectetur
										adipisicing elit. Recusandae eum ipsum
										qui. Optio veniam aliquid, impedit
										expedita ullam pariatur delectus.
										Provident iste omnis eos saepe delectus
										aut consectetur! Eaque, blanditiis.
									</p>
								</div>
							</div>
							<div className='col-sm-4'>
								<div className='process__item'>
									<h4>Secure Your New Loan!</h4>
									<p>
										Lorem ipsum dolor sit amet consectetur
										adipisicing elit. Quisquam voluptatem
										ipsam nam beatae doloremque optio natus,
										sed similique repellat dolorem, enim
										consequatur velit veritatis ipsum,
										expedita quos maiores officiis? Aperiam.
									</p>
								</div>
							</div>
						</div>
